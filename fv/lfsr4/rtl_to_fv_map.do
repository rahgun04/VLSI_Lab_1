...
# Generated on: Wed Oct 08 12:32:47 BST 2025 (Wed Oct 08 11:32:47 GMT 2025)

set lec_version [regsub {(-)[A-Za-z]} $env(LEC_VERSION) ""]

tcl_set_command_name_echo on

set_log_file fv/lfsr4/rtl_to_fv_map.log -replace

usage -auto -elapse

set_verification_information rtl_fv_map_db

read_implementation_information fv/lfsr4 -revised fv_map
...
set env(CDN_SYNTH_ROOT) "/usr/local/cadence/GENUS_18.10.000/tools.lnx86"
set CDN_SYNTH_ROOT      "/usr/local/cadence/GENUS_18.10.000/tools.lnx86"
set env(CW_DIR) "/usr/local/cadence/GENUS_18.10.000/tools.lnx86/lib/chipware"
set CW_DIR      "/usr/local/cadence/GENUS_18.10.000/tools.lnx86/lib/chipware"
set env(NCPROTECT_KEYDB) /usr/local/cadence/INCISIVE_15.20.058/kits/VerificationKit/misc/ip_keys

# default is to error out when module definitions are missing
set_undefined_cell black_box -noascend -both

add_search_path . /usr/local/cadence/GENUS_18.10.000/tools.lnx86/lib/tech -library -both
read_library -liberty -both   /usr/local/cadence/kits/tsmc/beLibs/65nm/TSMCHOME/digital/Front_End/timing_power_noise/NLDM/tcbn65lpbwp7t_220a/tcbn65lpbwp7twc.lib
...
read_design -enumconstraint  -define SYNTHESIS  -merge bbox -golden -lastmod -noelab -sv09 SRC/lfsr4.sv
elaborate_design -golden -root {lfsr4} -rootonly 

read_design -verilog95   -revised -lastmod -noelab fv/lfsr4/fv_map.v.gz
elaborate_design -revised -root {lfsr4}
...
#add_name_alias fv/lfsr4/fv_map.singlebit.original_name.alias.json.gz -revised
